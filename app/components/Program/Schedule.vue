      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        >
          <div class="text-center">
            <!-- Icon -->
            <div
              class="w-16 h-16 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center mb-4 mx-auto"
            >
              <UIcon name="i-heroicons-clock" class="text-3xl text-primary-600 dark:text-primary-400" />
            </div>
