...
<template>
  <div class="w-full min-h-screen">
    ...
    <section class="relative w-full min-h-max overflow-hidden bg-gray-100 scroll-mt-18" id="sekolah-kami">
      ...
      <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex flex-col lg:flex-row">
        ...
        >
          <div data-kinesisscroll-item data-ks-strength="50" data-ks-transform="rotate" class="absolute inset-0">
            <div class="relative w-full h-full">
              ...
              <div class="absolute w-12 h-12 sm:w-14 sm:h-14 top-24 sm:top-28 lg:top-44 left-10 sm:left-14 lg:left-32">
        ...
        <!-- Area model -->
        <div v-if="!isMobile" class="flex h-full w-full absolute items-center -z-20">
          <div class="rounded-full bg-linear-to-bl from-raka-orange to-raka-red h-132 w-132"></div>
        </div>
    ...
    <section class="w-full bg-gray-100 text-black" id="montessori">
      <div class="flex items-center justify-center mx-auto max-w-max px-4 sm:px-6 lg:px-8 py-10">
    ...
    <section class="w-full bg-gray-100 text-white" id="learn-more">
      <div class="flex items-center justify-center mx-auto max-w-max px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <template #left>
            <div class="grid gap-8 md:gap-10 md:pt-10 lg:pt-16">
              <div class="flex flex-col gap-4 sm:gap-6 text-arcon md:pr-8">
                <div class="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold tracking-tight text-justify">
