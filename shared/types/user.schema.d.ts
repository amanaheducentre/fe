...
export type UserCheckBody = paths["/user/check"]["post"]["requestBody"]["content"]["application/json"];
export type UserCheckRes = paths["/user/check"]["post"]["responses"]["200"]["content"]["application/json"];

export type UserRegBody = paths["/user/register"]["post"]["requestBody"]["content"]["application/json"];
export type UserRegRes = paths["/user/register"]["post"]["responses"]["200"]["content"]["application/json"];
