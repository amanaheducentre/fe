...
export type CourseDetailData =
  paths["/course/{courseIdentifier}"]["get"]["responses"]["200"]["content"]["application/json"];

export type CourseCurriculumWithLectures =
  paths["/courses/{courseIdentifier}/curriculum"]["get"]["responses"]["200"]["content"]["application/json"];
